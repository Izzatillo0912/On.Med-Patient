...
import com.arfomax.onmed.presentation.ui.bottomSheets.deleteQueueForDoctor.DeleteQueueForDoctorViewModel
...
@AndroidEntryPoint
class DeleteQueueForInspectionBottomSheet(val queueId : Int, val queuesForInspectionViewModel: QueuesForInspectionViewModel,
                             val inspectionId : Int, val date : String) : BottomSheetDialogFragment() {

    private lateinit var binding: BottomSheetDeleteQueueBinding
    private lateinit var actionResultDialog: ActionResultDialog
    private val viewModel by viewModels<DeleteQueueForInspectionViewModel>()
